...
void PrintHelp()
{
    ...
    printf("   options:\n");
    printf("             -b                    run app in background/daemon mode\n");
    printf("             -c <path>             config file at <path> (default /etc/munshin.conf)\n");
    printf("             -f <path>             config file at <path> (default /etc/munshin.conf)\n");
    printf("             -q <number>           allow <number> queued connections wating on 'listen/accept'\n");
    printf("             -listen <number>      allow <number> queued connections wating on 'listen/accept'\n");
